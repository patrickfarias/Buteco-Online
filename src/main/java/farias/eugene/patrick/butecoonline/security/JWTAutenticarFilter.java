package farias.eugene.patrick.butecoonline.security;
...
public class JWTAutenticarFilter extends UsernamePasswordAuthenticationFilter {
	...
	public static final int TOKEN_EXPIRACAO =  7200000; // 30 minutos
	
	// Essa senha em prod deve estar em um arquivo de configuracao
